...
public class Settings {
	...
	public String getPhno_is_active() {
		return appPref.getString("phno_is_active");
	}
	...
	public String getAddress_is_active() {
		return appPref.getString("address_is_active");
	}
	...
	public String getQuestions_left_isactive() {
		return appPref.getString("questions_left_isactive");
	}
	...
	public String getBg_colour() {
		return appPref.getString("bg_colour");
	}
	...
	public String getLayout_heading() {
		return appPref.getString("layout_heading");
	}
	...
	public String getEmail_is_active() {
		return appPref.getString("email_is_active");
	}
	...
	public String getLock_is_active() {
		return appPref.getString("lock_is_active");
	}
	...
	public String getLayout_colour() {
		return appPref.getString("layout_colour");
	}
	...
	public String getCustomerinfo_is_active() {
		return appPref.getString("customerinfo_is_active");
	}
	...
	public String getName_is_active() {
		return appPref.getString("name_is_active");
	}
	...
	public String getPersonaldesc_is_active() {
		return appPref.getString("personaldesc_is_active");
	}
	...
	public String getThankyou_timeout() {
		return appPref.getString("thankyou_timeout");
	}
